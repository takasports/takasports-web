...
import { TZ_OPTIONS, getTZOffset, type TZOption } from '@/lib/timezone'
      ...
      {open && (
        <div
          ...
          style={{
            ...
            borderRadius: 14,
            boxShadow: '0 20px 48px rgba(0,0,0,0.65), 0 0 0 1px rgba(124,58,237,0.1)',
            overflow: 'hidden',
          }}
        >
          {/* Search */}
          ...
          >
            {regions.length === 0 ? (
              ...
              regions.map((region) => (
                <div key={region}>
                  {/* Region header — solo cuando hay múltiples regiones o no hay filtro */}
                  {regions.length > 1 && (
                    <div
          ...
          >
            ...
            <button
              ...
              style={{ color: '#5A4878', fontFamily: 'var(--font-sport)', background: 'none', border: 'none', cursor: 'pointer' }}
            >
              Usar mi zona →
            </button>
          </div>
