...
const GK: Player[] = [
  ...
  { id: 'schmeichel-p', name: 'Peter Schmeichel', club: 'Manchester United', country: 'Dinamarca', position: 'GK', era: 'historic' },
  { id: 'buffon', name: 'Gianluigi Buffon', club: 'Juventus', country: 'Italia', position: 'GK', era: 'historic' },
  ...
  { id: 'vansar', name: 'Edwin van der Sar', club: 'Manchester United', country: 'Países Bajos', position: 'GK', era: 'historic' },
  { id: 'taffarel', name: 'Cláudio Taffarel', club: 'Galatasaray', country: 'Brasil', position: 'GK', era: 'historic' },
  { id: 'cech', name: 'Petr Čech', club: 'Chelsea', country: 'Chequia', position: 'GK', era: 'historic' },
  ...
  { id: 'reina', name: 'Pepe Reina', club: 'Liverpool', country: 'España', position: 'GK', era: 'historic' },
  ...
  { id: 'courtois', name: 'Thibaut Courtois', club: 'Real Madrid', country: 'Bélgica', position: 'GK', era: 'current' },
  { id: 'alisson', name: 'Alisson Becker', club: 'Liverpool', country: 'Brasil', position: 'GK', era: 'current' },
  { id: 'ederson', name: 'Ederson', club: 'Manchester City', country: 'Brasil', position: 'GK', era: 'current' },
  ...
  { id: 'lloris', name: 'Hugo Lloris', club: 'Tottenham', country: 'Francia', position: 'GK', era: 'historic' },
  { id: 'navas-k', name: 'Keylor Navas', club: 'Real Madrid', country: 'Costa Rica', position: 'GK', era: 'current' },
  ...
  { id: 'sommer', name: 'Yann Sommer', club: 'Internazionale', country: 'Suiza', position: 'GK', era: 'current' },
  { id: 'onana', name: 'André Onana', club: 'Manchester United', country: 'Camerún', position: 'GK', era: 'current' },
  { id: 'bono', name: 'Yassine Bounou', club: 'Al-Hilal', country: 'Marruecos', position: 'GK', era: 'current' },
  { id: 'szczesny', name: 'Wojciech Szczęsny', club: 'Juventus', country: 'Polonia', position: 'GK', era: 'current' },
  { id: 'unai-simon', name: 'Unai Simón', club: 'Athletic Club', country: 'España', position: 'GK', era: 'current' },
  { id: 'kepa', name: 'Kepa Arrizabalaga', club: 'Chelsea', country: 'España', position: 'GK', era: 'current' },
...
const DEF: Player[] = [
  ...
  { id: 'cannavaro', name: 'Fabio Cannavaro', club: 'Real Madrid', country: 'Italia', position: 'DEF', era: 'historic' },
  { id: 'nesta', name: 'Alessandro Nesta', club: 'Milan', country: 'Italia', position: 'DEF', era: 'historic' },
  { id: 'thuram', name: 'Lilian Thuram', club: 'Juventus', country: 'Francia', position: 'DEF', era: 'historic' },
  { id: 'desailly', name: 'Marcel Desailly', club: 'Chelsea', country: 'Francia', position: 'DEF', era: 'historic' },
  { id: 'blanc', name: 'Laurent Blanc', club: 'Manchester United', country: 'Francia', position: 'DEF', era: 'historic' },
  ...
  { id: 'sergio-ramos', name: 'Sergio Ramos', club: 'Real Madrid', country: 'España', position: 'DEF', era: 'historic' },
  { id: 'pique', name: 'Gerard Piqué', club: 'FC Barcelona', country: 'España', position: 'DEF', era: 'historic' },
  ...
  { id: 'cafu', name: 'Cafú', club: 'Roma', country: 'Brasil', position: 'DEF', era: 'historic' },
  { id: 'aldair', name: 'Aldair', club: 'Roma', country: 'Brasil', position: 'DEF', era: 'historic' },
  { id: 'lucio', name: 'Lúcio', club: 'Internazionale', country: 'Brasil', position: 'DEF', era: 'historic' },
  ...
  { id: 'samuel', name: 'Walter Samuel', club: 'Internazionale', country: 'Argentina', position: 'DEF', era: 'historic' },
  { id: 'heinze', name: 'Gabriel Heinze', club: 'Manchester United', country: 'Argentina', position: 'DEF', era: 'historic' },
  { id: 'sorin', name: 'Juan Pablo Sorín', club: 'Villarreal', country: 'Argentina', position: 'DEF', era: 'historic' },
  { id: 'koeman', name: 'Ronald Koeman', club: 'FC Barcelona', country: 'Países Bajos', position: 'DEF', era: 'historic' },
  { id: 'rijkaard', name: 'Frank Rijkaard', club: 'Milan', country: 'Países Bajos', position: 'DEF', era: 'historic' },
  { id: 'stam', name: 'Jaap Stam', club: 'Manchester United', country: 'Países Bajos', position: 'DEF', era: 'historic' },
  { id: 'matthaus', name: 'Lothar Matthäus', club: 'Bayern Múnich', country: 'Alemania', position: 'DEF', era: 'historic' },
  { id: 'kohler', name: 'Jürgen Kohler', club: 'Borussia Dortmund', country: 'Alemania', position: 'DEF', era: 'historic' },
  { id: 'sammer', name: 'Matthias Sammer', club: 'Borussia Dortmund', country: 'Alemania', position: 'DEF', era: 'historic' },
  ...
  { id: 'terry', name: 'John Terry', club: 'Chelsea', country: 'Inglaterra', position: 'DEF', era: 'historic' },
  { id: 'ferdinand', name: 'Rio Ferdinand', club: 'Manchester United', country: 'Inglaterra', position: 'DEF', era: 'historic' },
  { id: 'campbell', name: 'Sol Campbell', club: 'Arsenal', country: 'Inglaterra', position: 'DEF', era: 'historic' },
  { id: 'cole-a', name: 'Ashley Cole', club: 'Chelsea', country: 'Inglaterra', position: 'DEF', era: 'historic' },
  ...
  { id: 'vidic', name: 'Nemanja Vidić', club: 'Manchester United', country: 'Serbia', position: 'DEF', era: 'historic' },
  { id: 'puskas', name: 'Carlos Gamarra', club: 'Atlético Paranaense', country: 'Paraguay', position: 'DEF', era: 'historic' },
  { id: 'stankovic', name: 'Dejan Stanković', club: 'Internazionale', country: 'Serbia', position: 'DEF', era: 'historic' },
  ...
  { id: 'carvalho-r', name: 'Ricardo Carvalho', club: 'Chelsea', country: 'Portugal', position: 'DEF', era: 'historic' },
  { id: 'coentrao', name: 'Fábio Coentrão', club: 'Real Madrid', country: 'Portugal', position: 'DEF', era: 'historic' },

  // Actuales
  { id: 'van-dijk', name: 'Virgil van Dijk', club: 'Liverpool', country: 'Países Bajos', position: 'DEF', era: 'current' },
  { id: 'rudiger', name: 'Antonio Rüdiger', club: 'Real Madrid', country: 'Alemania', position: 'DEF', era: 'current' },
  { id: 'alaba', name: 'David Alaba', club: 'Real Madrid', country: 'Austria', position: 'DEF', era: 'current' },
  ...
  { id: 'walker', name: 'Kyle Walker', club: 'Manchester City', country: 'Inglaterra', position: 'DEF', era: 'current' },
  { id: 'akanji', name: 'Manuel Akanji', club: 'Manchester City', country: 'Suiza', position: 'DEF', era: 'current' },
  { id: 'gvardiol', name: 'Joško Gvardiol', club: 'Manchester City', country: 'Croacia', position: 'DEF', era: 'current' },
  { id: 'stones', name: 'John Stones', club: 'Manchester City', country: 'Inglaterra', position: 'DEF', era: 'current' },
  ...
  { id: 'konate', name: 'Ibrahima Konaté', club: 'Liverpool', country: 'Francia', position: 'DEF', era: 'current' },
  ...
  { id: 'zinchenko', name: 'Oleksandr Zinchenko', club: 'Arsenal', country: 'Ucrania', position: 'DEF', era: 'current' },
  ...
  { id: 'pavard', name: 'Benjamin Pavard', club: 'Internazionale', country: 'Francia', position: 'DEF', era: 'current' },
  { id: 'kim', name: 'Kim Min-jae', club: 'Bayern Múnich', country: 'Corea del Sur', position: 'DEF', era: 'current' },
  ...
  { id: 'hakimi', name: 'Achraf Hakimi', club: 'Paris Saint-Germain', country: 'Marruecos', position: 'DEF', era: 'current' },
  { id: 'marquinhos', name: 'Marquinhos', club: 'Paris Saint-Germain', country: 'Brasil', position: 'DEF', era: 'current' },
  { id: 'theo', name: 'Theo Hernández', club: 'Milan', country: 'Francia', position: 'DEF', era: 'current' },
  { id: 'tomori', name: 'Fikayo Tomori', club: 'Milan', country: 'Inglaterra', position: 'DEF', era: 'current' },
  ...
  { id: 'dalot', name: 'Diogo Dalot', club: 'Manchester United', country: 'Portugal', position: 'DEF', era: 'current' },
  ...
  { id: 'frimpong', name: 'Jeremie Frimpong', club: 'Bayer Leverkusen', country: 'Países Bajos', position: 'DEF', era: 'current' },
  { id: 'grimaldo', name: 'Álex Grimaldo', club: 'Bayer Leverkusen', country: 'España', position: 'DEF', era: 'current' },
  ...
  { id: 'nuno-mendes', name: 'Nuno Mendes', club: 'Paris Saint-Germain', country: 'Portugal', position: 'DEF', era: 'current' },
  { id: 'inigo', name: 'Iñigo Martínez', club: 'FC Barcelona', country: 'España', position: 'DEF', era: 'current' },
  { id: 'laporte', name: 'Aymeric Laporte', club: 'Al-Nassr', country: 'España', position: 'DEF', era: 'current' },
]
...
const MID: Player[] = [
  ...
  { id: 'zidane', name: 'Zinédine Zidane', club: 'Real Madrid', country: 'Francia', position: 'MID', era: 'historic' },
  { id: 'maradona', name: 'Diego Maradona', club: 'Napoli', country: 'Argentina', position: 'MID', era: 'historic' },
  { id: 'pele', name: 'Pelé', club: 'Santos', country: 'Brasil', position: 'MID', era: 'historic' },
  { id: 'di-stefano', name: 'Alfredo Di Stéfano', club: 'Real Madrid', country: 'Argentina', position: 'MID', era: 'historic' },
  ...
  { id: 'baggio', name: 'Roberto Baggio', club: 'Juventus', country: 'Italia', position: 'MID', era: 'historic' },
  { id: 'mancini-r', name: 'Roberto Mancini', club: 'Sampdoria', country: 'Italia', position: 'MID', era: 'historic' },
  ...
  // Actuales
  { id: 'modric', name: 'Luka Modrić', club: 'Real Madrid', country: 'Croacia', position: 'MID', era: 'current' },
  ...
  { id: 'ilkay', name: 'İlkay Gündoğan', club: 'FC Barcelona', country: 'Alemania', position: 'MID', era: 'current' },
  ...
  { id: 'kovacic', name: 'Mateo Kovačić', club: 'Manchester City', country: 'Croacia', position: 'MID', era: 'current' },
  ...
  { id: 'havertz', name: 'Kai Havertz', club: 'Arsenal', country: 'Alemania', position: 'MID', era: 'current' },
  { id: 'partey', name: 'Thomas Partey', club: 'Arsenal', country: 'Ghana', position: 'MID', era: 'current' },
  ...
  { id: 'casemiro', name: 'Casemiro', club: 'Manchester United', country: 'Brasil', position: 'MID', era: 'current' },
  { id: 'eriksen', name: 'Christian Eriksen', club: 'Manchester United', country: 'Dinamarca', position: 'MID', era: 'current' },
  { id: 'barella', name: 'Nicolò Barella', club: 'Internazionale', country: 'Italia', position: 'MID', era: 'current' },
  { id: 'calhanoglu', name: 'Hakan Çalhanoğlu', club: 'Internazionale', country: 'Turquía', position: 'MID', era: 'current' },
  { id: 'mkhitaryan', name: 'Henrikh Mkhitaryan', club: 'Internazionale', country: 'Armenia', position: 'MID', era: 'current' },
  ...
  { id: 'pulisic', name: 'Christian Pulisic', club: 'Milan', country: 'Estados Unidos', position: 'MID', era: 'current' },
  { id: 'loftus-cheek', name: 'Ruben Loftus-Cheek', club: 'Milan', country: 'Inglaterra', position: 'MID', era: 'current' },
  ...
  { id: 'sane', name: 'Leroy Sané', club: 'Bayern Múnich', country: 'Alemania', position: 'MID', era: 'current' },
  { id: 'rabiot', name: 'Adrien Rabiot', club: 'Marsella', country: 'Francia', position: 'MID', era: 'current' },
  ...
  { id: 'xhaka', name: 'Granit Xhaka', club: 'Bayer Leverkusen', country: 'Suiza', position: 'MID', era: 'current' },
  { id: 'fabian', name: 'Fabián Ruiz', club: 'Paris Saint-Germain', country: 'España', position: 'MID', era: 'current' },
  { id: 'vitinha', name: 'Vitinha', club: 'Paris Saint-Germain', country: 'Portugal', position: 'MID', era: 'current' },
  { id: 'ugarte', name: 'Manuel Ugarte', club: 'Manchester United', country: 'Uruguay', position: 'MID', era: 'current' },
  { id: 'zubimendi', name: 'Martín Zubimendi', club: 'Real Sociedad', country: 'España', position: 'MID', era: 'current' },
  { id: 'merino', name: 'Mikel Merino', club: 'Real Sociedad', country: 'España', position: 'MID', era: 'current' },
  { id: 'olmo', name: 'Dani Olmo', club: 'FC Barcelona', country: 'España', position: 'MID', era: 'current' },
...
const FWD: Player[] = [
  ...
  { id: 'morientes', name: 'Fernando Morientes', club: 'Real Madrid', country: 'España', position: 'FWD', era: 'historic' },
  { id: 'villa', name: 'David Villa', club: 'Valencia', country: 'España', position: 'FWD', era: 'historic' },
  { id: 'torres', name: 'Fernando Torres', club: 'Liverpool', country: 'España', position: 'FWD', era: 'historic' },
  ...
  { id: 'klose', name: 'Miroslav Klose', club: 'Lazio', country: 'Alemania', position: 'FWD', era: 'historic' },
  { id: 'podolski', name: 'Lukas Podolski', club: 'Arsenal', country: 'Alemania', position: 'FWD', era: 'historic' },
  ...
  { id: 'falcao-r', name: 'Radamel Falcao', club: 'Atlético de Madrid', country: 'Colombia', position: 'FWD', era: 'historic' },
  { id: 'hagi', name: 'Gheorghe Hagi', club: 'Galatasaray', country: 'Rumanía', position: 'FWD', era: 'historic' },
  ...
  // Actuales
  { id: 'haaland', name: 'Erling Haaland', club: 'Manchester City', country: 'Noruega', position: 'FWD', era: 'current' },
  { id: 'mbappe', name: 'Kylian Mbappé', club: 'Real Madrid', country: 'Francia', position: 'FWD', era: 'current' },
  ...
  { id: 'lewandowski', name: 'Robert Lewandowski', club: 'FC Barcelona', country: 'Polonia', position: 'FWD', era: 'current' },
  ...
  { id: 'son', name: 'Son Heung-min', club: 'Tottenham', country: 'Corea del Sur', position: 'FWD', era: 'current' },
  { id: 'kane', name: 'Harry Kane', club: 'Bayern Múnich', country: 'Inglaterra', position: 'FWD', era: 'current' },
  ...
  { id: 'sterling', name: 'Raheem Sterling', club: 'Chelsea', country: 'Inglaterra', position: 'FWD', era: 'current' },
  ...
  { id: 'rashford', name: 'Marcus Rashford', club: 'Manchester United', country: 'Inglaterra', position: 'FWD', era: 'current' },
  ...
  { id: 'haaland-ruben', name: 'Julián Álvarez', club: 'Atlético de Madrid', country: 'Argentina', position: 'FWD', era: 'current' },
  { id: 'doku', name: 'Jérémy Doku', club: 'Manchester City', country: 'Bélgica', position: 'FWD', era: 'current' },
  { id: 'grealish', name: 'Jack Grealish', club: 'Manchester City', country: 'Inglaterra', position: 'FWD', era: 'current' },
  ...
  { id: 'chiesa', name: 'Federico Chiesa', club: 'Liverpool', country: 'Italia', position: 'FWD', era: 'current' },
  ...
  { id: 'aubameyang', name: 'Pierre-Emerick Aubameyang', club: 'Marsella', country: 'Gabón', position: 'FWD', era: 'historic' },
  { id: 'icardi', name: 'Mauro Icardi', club: 'Galatasaray', country: 'Argentina', position: 'FWD', era: 'historic' },
  ...
  { id: 'havertz-2', name: 'Timo Werner', club: 'RB Leipzig', country: 'Alemania', position: 'FWD', era: 'current' },
