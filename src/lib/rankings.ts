...
export const RANKING_CREADORES_WWE: RankingEntry[] = [
  {
    ...
    emoji: '🎬', country: '🇬🇧',
    image: 'https://yt3.ggpht.com/ymdlVt4ErcJpkQplIDve8bgiwfYOaIlyTr1IjU97FXZvRSeceR7L_q9U9jG7zNidT-2L-V6a=s400-c-k-c0x00ffffff-no-rj',
  ...
  },
  {
    ...
    emoji: '🎙️', country: '🇺🇸',
    image: 'https://yt3.ggpht.com/Fo3Ujs3bjx4lbdHCHcDnj2NF7q9XQNYdYRQc0PewGHWhCMwqtAuW3JawdPPZYCPczDy3Mf-FUQ=s400-c-k-c0x00ffffff-no-rj',
  ...
  },
  {
    ...
    emoji: '🎧', country: '🇺🇸',
    image: 'https://yt3.ggpht.com/zY3-soIrMl-DaYyN07ELtfCR4HO01tIYDT1d306CMnl5Mr3bzkUzGApNjWBBp0NC3lbhzEFESkw=s400-c-k-c0x00ffffff-no-rj',
...
// Datos verificados mayo 2026. Solo periodistas/analistas reales con presencia activa.
export const RANKING_PERIODISTAS: RankingEntry[] = [
  // ── Fútbol ────────────────────────────────────────────────────
  {
    id: 'pedrerol', rank: 1, name: 'Josep Pedrerol', subtitle: 'El Chiringuito de Jugones · Atresmedia',
    sport: 'futbol', score: 90.9, trend: 'flat', badge: 'Histórico',
    insight: 'El presentador más influyente del periodismo deportivo español. El Chiringuito define la agenda del fútbol nocturno en España.',
    emoji: '📺',
    scorePrev: 91.0, trendReason: 'El Chiringuito sigue marcando la agenda del fútbol español — influencia mediática incuestionable',
    factors: { rendimiento: 90, contexto: 90, mediatico: 94, narrativa: 89 },
  },
  {
    id: 'guillembalague', rank: 2, name: 'Guillem Balagué', subtitle: 'BBC Radio 5 Live · Internacional',
    sport: 'futbol', score: 90.7, trend: 'flat', badge: 'Histórico',
    insight: 'La voz del fútbol español para el mundo anglófono. 1M+ en Twitter, biógrafo de Messi y Guardiola, acceso a vestuarios de élite.',
    emoji: '🌍',
    scorePrev: 90.5, trendReason: 'Sigue siendo la voz del fútbol español para el mundo — biógrafo y acceso único',
    factors: { rendimiento: 90, contexto: 91, mediatico: 91, narrativa: 91 },
  },
  {
    id: 'helenacondis', rank: 3, name: 'Helena Condis', subtitle: 'Cadena COPE · Periodismo Digital',
    sport: 'futbol', score: 87.3, trend: 'up',
    insight: 'Periodismo de campo con rigor. Especialista en FC Barcelona en Cadena COPE, 172K en Twitter y acceso privilegiado al club.',
    emoji: '📻',
    scorePrev: 86.0, trendReason: 'Cobertura privilegiada del Barça en COPE + alcance digital creciente — fuente de referencia',
    factors: { rendimiento: 89, contexto: 87, mediatico: 84, narrativa: 89 },
  },
  {
    id: 'tomasroncero', rank: 4, name: 'Tomás Roncero', subtitle: 'AS · El Chiringuito de Jugones',
    sport: 'futbol', score: 84.4, trend: 'flat',
    insight: 'El madridista más reconocible del periodismo español. 1.3M en Twitter, voz habitual de El Chiringuito y jefe de Real Madrid en AS.',
    emoji: '📰',
    scorePrev: 84.5, trendReason: '1.3M en Twitter — polarización como herramienta de alcance masivo en el ecosistema del fútbol',
    factors: { rendimiento: 82, contexto: 83, mediatico: 91, narrativa: 81 },
  },
  {
    id: 'kikemateu', rank: 5, name: 'Kike Mateu', subtitle: 'El Chiringuito de Jugones · TV',
    sport: 'futbol', score: 76.1, trend: 'flat',
    insight: 'Colaborador fijo de El Chiringuito desde sus orígenes. Crónica habitual del fútbol valenciano y la Liga con tono apasionado.',
    emoji: '🎙️',
    scorePrev: 76.0, trendReason: 'Colaborador histórico de El Chiringuito — voz del fútbol valenciano en TV durante años',
    factors: { rendimiento: 77, contexto: 76, mediatico: 72, narrativa: 81 },
  },
  // ── NBA / Baloncesto ──────────────────────────────────────────
  {
    id: 'shamscharania', rank: 1, name: 'Shams Charania', subtitle: 'ESPN · NBA Senior Insider',
    sport: 'baloncesto', score: 92.6, trend: 'up',
    insight: 'El insider NBA más rápido del planeta. 3.6M en Twitter. Primicia del anillo Thunder 2025, traspasos Doncic-Lakers y WNBA 2026.',
    emoji: '🏀',
    scorePrev: 91.0, trendReason: 'Insider #1 NBA global — primicia del anillo Thunder + mercado Doncic-Lakers + WNBA 2026',
    factors: { rendimiento: 93, contexto: 91, mediatico: 94, narrativa: 92 },
  },
  // ── Fórmula 1 ─────────────────────────────────────────────────
  {
    id: 'nicorosberg', rank: 1, name: 'Nico Rosberg', subtitle: 'DAZN F1 · YouTube / Análisis',
    sport: 'formula1', score: 88.5, trend: 'up',
    insight: 'Ex campeón del mundo 2016 con YouTube 1.16M. Visión técnica única sobre la era post-Verstappen y el reglamento 2026.',
    emoji: '🏆',
    scorePrev: 88.0, trendReason: 'Ex campeón con visión técnica única — referente analítico de la era post-Verstappen',
    factors: { rendimiento: 88, contexto: 88, mediatico: 88, narrativa: 91 },
  },
  {
    id: 'antoniolobato', rank: 2, name: 'Antonio Lobato', subtitle: 'DAZN F1 · TV & Digital',
    sport: 'formula1', score: 83.9, trend: 'flat',
    insight: 'La voz histórica de la F1 en español. DAZN, presencia digital consolidada y la pasión que lo identifica desde hace décadas.',
    emoji: '📡',
    scorePrev: 84.0, trendReason: 'Voz histórica de la F1 en español — DAZN y presencia digital estable',
    factors: { rendimiento: 83, contexto: 83, mediatico: 84, narrativa: 87 },
  },
  // ── Tenis ─────────────────────────────────────────────────────
  {
    id: 'josemorgado', rank: 1, name: 'José Morgado', subtitle: 'Record Portugal · Circuito ATP/WTA',
    sport: 'tenis', score: 85.9, trend: 'up',
    insight: '256K en Twitter. El periodista de tenis más citado en el circuito ATP/WTA. Fuente primaria del Career Slam de Alcaraz y la era Sinner.',
    emoji: '🎾',
  ...
  // ── Destacados ────────────────────────────────────────────────
  {
    id: 'adrianacioneros', rank: 0, name: 'Adriana Cisneros', subtitle: 'ESPN Deportes · LatAm',
    sport: 'futbol', score: 76.3, trend: 'up', featured: true,
    insight: 'La periodista deportiva latinoamericana con más proyección en ESPN Deportes. Cobertura del Mundial 2026 en marcha.',
    emoji: '🇲🇽',
    scorePrev: 74.8, trendReason: 'Crecimiento sostenido en ESPN Deportes — referente del periodismo deportivo latinoamericano',
