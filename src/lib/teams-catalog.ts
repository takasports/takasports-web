...
const TEAMS: Omit<TeamRecord, 'id'>[] = [
  ...
  { espnId: '5',   name: 'Boston Celtics',        shortName: 'Celtics',    abbr: 'BOS', sport: 'basketball', league: 'nba', country: 'US', primary: '#007A33', secondary: '#FFFFFF' },
  ...
  { espnId: '17',  name: 'Milwaukee Bucks',       shortName: 'Bucks',      abbr: 'MIL', sport: 'basketball', league: 'nba', country: 'US', primary: '#00471B', secondary: '#EEE1C6' },
  { espnId: '25',  name: 'Dallas Mavericks',      shortName: 'Mavs',       abbr: 'DAL', sport: 'basketball', league: 'nba', country: 'US', primary: '#00538C', secondary: '#002B5E' },
  { espnId: '24',  name: 'Los Angeles Clippers',  shortName: 'Clippers',   abbr: 'LAC', sport: 'basketball', league: 'nba', country: 'US', primary: '#C8102E', secondary: '#1D428A' },
  { espnId: '27',  name: 'Phoenix Suns',          shortName: 'Suns',       abbr: 'PHX', sport: 'basketball', league: 'nba', country: 'US', primary: '#1D1160', secondary: '#E56020' },
  { espnId: '21',  name: 'Philadelphia 76ers',    shortName: '76ers',      abbr: 'PHI', sport: 'basketball', league: 'nba', country: 'US', primary: '#006BB6', secondary: '#ED174C' },
  ...
  { espnId: '20',  name: 'Brooklyn Nets',         shortName: 'Nets',       abbr: 'BKN', sport: 'basketball', league: 'nba', country: 'US', primary: '#000000', secondary: '#FFFFFF' },
  ...
  { espnId: '6',   name: 'Cleveland Cavaliers',   shortName: 'Cavs',       abbr: 'CLE', sport: 'basketball', league: 'nba', country: 'US', primary: '#860038', secondary: '#FDBB30' },
  ...
  { espnId: '23',  name: 'Oklahoma City Thunder', shortName: 'Thunder',    abbr: 'OKC', sport: 'basketball', league: 'nba', country: 'US', primary: '#007AC1', secondary: '#EF3B24' },
  ...
  { espnId: '15',  name: 'Minnesota Timberwolves',shortName: 'Wolves',     abbr: 'MIN', sport: 'basketball', league: 'nba', country: 'US', primary: '#0C2340', secondary: '#236192' },
  { espnId: '16',  name: 'Memphis Grizzlies',     shortName: 'Grizzlies',  abbr: 'MEM', sport: 'basketball', league: 'nba', country: 'US', primary: '#5D76A9', secondary: '#12173F' },
  ...
  { espnId: '26',  name: 'Sacramento Kings',      shortName: 'Kings',      abbr: 'SAC', sport: 'basketball', league: 'nba', country: 'US', primary: '#5A2D81', secondary: '#63727A' },
  { espnId: '28',  name: 'San Antonio Spurs',     shortName: 'Spurs',      abbr: 'SAS', sport: 'basketball', league: 'nba', country: 'US', primary: '#000000', secondary: '#C4CED4' },
  { espnId: '29',  name: 'Toronto Raptors',       shortName: 'Raptors',    abbr: 'TOR', sport: 'basketball', league: 'nba', country: 'US', primary: '#CE1141', secondary: '#000000' },
  { espnId: '30',  name: 'Utah Jazz',             shortName: 'Jazz',       abbr: 'UTA', sport: 'basketball', league: 'nba', country: 'US', primary: '#002B5C', secondary: '#F9A01B' },
  ...
  { espnId: '2',   name: 'Charlotte Hornets',     shortName: 'Hornets',    abbr: 'CHA', sport: 'basketball', league: 'nba', country: 'US', primary: '#1D1160', secondary: '#00788C' },
  { espnId: '3',   name: 'Washington Wizards',    shortName: 'Wizards',    abbr: 'WAS', sport: 'basketball', league: 'nba', country: 'US', primary: '#002B5C', secondary: '#E31837' },
  { espnId: '12',  name: 'New Orleans Pelicans',  shortName: 'Pelicans',   abbr: 'NOP', sport: 'basketball', league: 'nba', country: 'US', primary: '#0C2340', secondary: '#C8102E' },
]
