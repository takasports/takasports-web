        ...
        blocks: [
          {
            ...
            rows: [
              { rank: 1, name: 'Boston Celtics',    value: '61-21', sub: '1º Este',  trend: 'flat', extra: { Racha: '7V', Pts: '120.1' } },
              { rank: 2, name: 'Milwaukee Bucks',   value: '48-34', sub: '2º Este',  trend: 'up',   extra: { Racha: '3V', Pts: '116.8' } },
              { rank: 3, name: 'New York Knicks',   value: '44-23', sub: '3º Este',  trend: 'up',   extra: { Racha: '4V', Pts: '112.4' } },
              { rank: 4, name: 'Cleveland Cavs',    value: '43-24', sub: '4º Este',  trend: 'up',   extra: { Racha: '2V', Pts: '113.0' } },
              { rank: 5, name: 'Indiana Pacers',    value: '41-26', sub: '5º Este',  trend: 'flat', extra: { Racha: '1V', Pts: '118.9' } },
              { rank: 6, name: 'Orlando Magic',     value: '39-28', sub: '6º Este',  trend: 'up',   extra: { Racha: '3V', Pts: '109.5' } },
              { rank: 7, name: 'Philadelphia 76ers',value: '36-31', sub: '7º Este',  trend: 'down', extra: { Racha: '2D', Pts: '108.4' } },
            ],
          },
          {
            id: 'nba-oeste', title: 'Conferencia Oeste', metric: 'W-L',
            rows: [
              { rank: 1, name: 'OKC Thunder',        value: '55-12', sub: '1º Oeste', trend: 'up',   extra: { Racha: '8V', Pts: '119.2' } },
              { rank: 2, name: 'Denver Nuggets',     value: '48-19', sub: '2º Oeste', trend: 'flat', extra: { Racha: '3V', Pts: '116.5' } },
              { rank: 3, name: 'Minnesota Timberwolves', value: '44-23', sub: '3º Oeste', trend: 'flat', extra: { Racha: '2V', Pts: '112.1' } },
              { rank: 4, name: 'LA Lakers',          value: '41-26', sub: '4º Oeste', trend: 'up',   extra: { Racha: '4V', Pts: '114.6' } },
              { rank: 5, name: 'Dallas Mavericks',   value: '38-29', sub: '5º Oeste', trend: 'down', extra: { Racha: '1D', Pts: '113.8' } },
              { rank: 6, name: 'Phoenix Suns',       value: '36-31', sub: '6º Oeste', trend: 'flat', extra: { Racha: '2V', Pts: '112.0' } },
            ],
          },
        ],
      },
        ...
        blocks: [
          {
            ...
            rows: [
              { rank: 1, name: 'Kimi Antonelli',  team: 'Mercedes',  value: '72',  sub: 'Temp. 2025', flag: '🇮🇹', trend: 'up',   extra: { Vic: '1', Podios: '3' } },
              { rank: 2, name: 'George Russell',  team: 'Mercedes',  value: '63',  sub: 'Temp. 2025', flag: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', trend: 'up',   extra: { Vic: '1', Podios: '2' } },
              { rank: 3, name: 'Charles Leclerc', team: 'Ferrari',   value: '49',  sub: 'Temp. 2025', flag: '🇲🇨', trend: 'flat', extra: { Vic: '0', Podios: '2' } },
              { rank: 4, name: 'Lando Norris',    team: 'McLaren',   value: '46',  sub: 'Temp. 2025', flag: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', trend: 'flat', extra: { Vic: '0', Podios: '2' } },
              { rank: 5, name: 'Max Verstappen',  team: 'Red Bull',  value: '45',  sub: 'Temp. 2025', flag: '🇳🇱', trend: 'down', extra: { Vic: '0', Podios: '1' } },
              { rank: 6, name: 'Lewis Hamilton',  team: 'Ferrari',   value: '36',  sub: 'Temp. 2025', flag: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', trend: 'flat', extra: { Vic: '0', Podios: '1' } },
              { rank: 7, name: 'Carlos Sainz',    team: 'Williams',  value: '22',  sub: 'Temp. 2025', flag: '🇪🇸', trend: 'up',   extra: { Vic: '0', Podios: '0' } },
            ],
          },
          {
            id: 'f1-poles', title: 'Poles position', metric: 'Poles',
            rows: [
              { rank: 1, name: 'Kimi Antonelli',  team: 'Mercedes',  value: '2', sub: 'Temp. 2025', flag: '🇮🇹', trend: 'up' },
              { rank: 2, name: 'George Russell',  team: 'Mercedes',  value: '2', sub: 'Temp. 2025', flag: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', trend: 'flat' },
              { rank: 3, name: 'Charles Leclerc', team: 'Ferrari',   value: '1', sub: 'Temp. 2025', flag: '🇲🇨', trend: 'flat' },
              { rank: 4, name: 'Lando Norris',    team: 'McLaren',   value: '1', sub: 'Temp. 2025', flag: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', trend: 'flat' },
            ],
          },
          {
            id: 'f1-vueltas-rapidas', title: 'Vueltas rápidas', metric: 'VR',
            rows: [
              { rank: 1, name: 'George Russell',  team: 'Mercedes',  value: '2', sub: 'Temp. 2025', flag: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', trend: 'up' },
              { rank: 2, name: 'Kimi Antonelli',  team: 'Mercedes',  value: '1', sub: 'Temp. 2025', flag: '🇮🇹', trend: 'up' },
              { rank: 3, name: 'Max Verstappen',  team: 'Red Bull',  value: '1', sub: 'Temp. 2025', flag: '🇳🇱', trend: 'flat' },
              { rank: 4, name: 'Lewis Hamilton',  team: 'Ferrari',   value: '1', sub: 'Temp. 2025', flag: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', trend: 'flat' },
            ],
          },
        ],
      },
        ...
        blocks: [
          {
            ...
            rows: [
              { rank: 1, name: 'Mercedes',        value: '135', sub: 'Temp. 2025', trend: 'up' },
              { rank: 2, name: 'Ferrari',         value: '90',  sub: 'Temp. 2025', trend: 'flat' },
              { rank: 3, name: 'McLaren',         value: '46',  sub: 'Temp. 2025', trend: 'down' },
              { rank: 4, name: 'Red Bull Racing', value: '45',  sub: 'Temp. 2025', trend: 'down' },
              { rank: 5, name: 'Williams',        value: '22',  sub: 'Temp. 2025', trend: 'up' },
              { rank: 6, name: 'Aston Martin',    value: '14',  sub: 'Temp. 2025', trend: 'flat' },
              { rank: 7, name: 'Alpine',          value: '8',   sub: 'Temp. 2025', trend: 'flat' },
            ],
          },
        ],
      },
        ...
        blocks: [
          {
            ...
            rows: [
              { rank: 1, name: 'Jannik Sinner',    value: '11350', sub: '1 Grand Slam',   flag: '🇮🇹', trend: 'up',   extra: { GS: '1',  Torneos: '7' } },
              { rank: 2, name: 'Carlos Alcaraz',   value: '10700', sub: '2 Grand Slams',  flag: '🇪🇸', trend: 'flat', extra: { GS: '2',  Torneos: '5' } },
              { rank: 3, name: 'Novak Djokovic',   value: '9520',  sub: '24 Grand Slams', flag: '🇷🇸', trend: 'down', extra: { GS: '24', Torneos: '3' } },
              { rank: 4, name: 'Daniil Medvedev',  value: '8220',  sub: '1 Grand Slam',   flag: '🇷🇺', trend: 'flat', extra: { GS: '1',  Torneos: '4' } },
              { rank: 5, name: 'Alexander Zverev', value: '7560',  sub: '0 Grand Slams',  flag: '🇩🇪', trend: 'up',   extra: { GS: '0',  Torneos: '6' } },
              { rank: 6, name: 'Andrey Rublev',    value: '5210',  sub: '0 Grand Slams',  flag: '🇷🇺', trend: 'flat', extra: { GS: '0',  Torneos: '3' } },
              { rank: 7, name: 'Hubert Hurkacz',   value: '4980',  sub: '0 Grand Slams',  flag: '🇵🇱', trend: 'up',   extra: { GS: '0',  Torneos: '4' } },
              { rank: 8, name: 'Grigor Dimitrov',  value: '3750',  sub: '0 Grand Slams',  flag: '🇧🇬', trend: 'up',   extra: { GS: '0',  Torneos: '3' } },
            ],
          },
          {
            id: 'atp-wins-surface', title: 'Victorias por superficie (ATP)', metric: '% Vic.',
            rows: [
              { rank: 1, name: 'Carlos Alcaraz', value: '88%', sub: 'Tierra · 2024', flag: '🇪🇸', trend: 'up',   extra: { Dura: '74%', Hierba: '82%' } },
              { rank: 2, name: 'Jannik Sinner',  value: '86%', sub: 'Dura · 2024',   flag: '🇮🇹', trend: 'up',   extra: { Dura: '86%', Tierra: '71%' } },
              { rank: 3, name: 'Novak Djokovic', value: '84%', sub: 'Global · 2024', flag: '🇷🇸', trend: 'flat', extra: { Dura: '82%', Tierra: '85%' } },
              { rank: 4, name: 'Zverev',         value: '76%', sub: 'Tierra · 2024', flag: '🇩🇪', trend: 'up',   extra: { Dura: '68%', Tierra: '76%' } },
              { rank: 5, name: 'Medvedev',       value: '79%', sub: 'Dura · 2024',   flag: '🇷🇺', trend: 'flat', extra: { Dura: '79%', Tierra: '60%' } },
            ],
          },
        ],
      },
        ...
        blocks: [
          {
            ...
            rows: [
              { rank: 1, name: 'Aryna Sabalenka', value: '10325', sub: '2 Grand Slams', flag: '🇧🇾', trend: 'flat', extra: { GS: '2', Torneos: '6' } },
              { rank: 2, name: 'Iga Swiatek',     value: '9625',  sub: '5 Grand Slams', flag: '🇵🇱', trend: 'flat', extra: { GS: '5', Torneos: '4' } },
              { rank: 3, name: 'Coco Gauff',      value: '7550',  sub: '1 Grand Slam',  flag: '🇺🇸', trend: 'up',   extra: { GS: '1', Torneos: '5' } },
              { rank: 4, name: 'Elena Rybakina',  value: '6625',  sub: '1 Grand Slam',  flag: '🇰🇿', trend: 'flat', extra: { GS: '1', Torneos: '3' } },
              { rank: 5, name: 'Zheng Qinwen',    value: '5830',  sub: '0 Grand Slams', flag: '🇨🇳', trend: 'up',   extra: { GS: '0', Torneos: '4' } },
              { rank: 6, name: 'Jessica Pegula',  value: '4890',  sub: '0 Grand Slams', flag: '🇺🇸', trend: 'flat', extra: { GS: '0', Torneos: '3' } },
              { rank: 7, name: 'Mirra Andreeva',  value: '2540',  sub: '0 Grand Slams', flag: '🇷🇺', trend: 'up',  extra: { GS: '0', Torneos: '2' } },
            ],
          },
        ],
      },
