...
//
// SSG/ISR (no force-dynamic): el 2026-07-19 se puso force-dynamic creyendo que SSG
// dejaba la vista sin hidratar en prod, pero ese "bug" era el service worker
// sirviendo HTML fósil a los navegadores de prueba (ver memoria verificacion-navegador-sw).
// Verificado con Chromium prístino (serviceWorkers:block): SSG + EstadisticasClientGate
// monta perfecto. Revertido a ISR para recuperar el caché de CDN de esta página insignia.
