...
import { getAllRankingEntries, findEntryById } from '@/lib/rankings-search'
...
export default function CompararPage() {
  ...
  const allEntries = useMemo(() => getAllRankingEntries(), [])
  const entryA = useMemo(() => findEntryById(idA), [idA])
  const entryB = useMemo(() => findEntryById(idB), [idB])
        ...
        {(!entryA || !entryB) ? (
          ...
          <>
            ...
            <div className="flex justify-center">
              ...
              >
                {shareState === 'copied' ? '✓ Link copiado' : '🔗 Compartir comparativa'}
              </button>
            </div>
          </>
        )}
